...
Mot de passe de tous les comptes : celui de `manage.py seed_demo` (constante PASSWORD).
"""
...
from apps.accounts.management.commands.seed_demo import PASSWORD  # noqa: E402
